...
- [ ] Given a pilot test, when conducted, then error rates are low. _Not met: 11.5% errors (3/26) vs a 5% limit after follow-up 1 — see pilot/results/followup-1.json._
